...
("힘세진", "평일 등어깨", "등운동 어깨운동 각각 5세트", "등", "어깨", 90, 14);

INSERT INTO routines (writer, title, content, part1, workout_time, user_id)
VALUES ("힘세진", "주말", "상체 하체 전부", "전신", 120, 14),
("야구민", "주말", "상체 하체 스트레칭", "전신", 120, 16),
("요가영", "주말 전신 순환~", "전신 순환 요가", "전신", 40, 12),
("배구빈", "주말 배구팀", "주말 배구팀 경기!", "전신", 180, 15);

INSERT INTO routines (writer, title, content, part1, part2, workout_time, user_id, is_marked)
VALUES ("강해진", "평일 3회", "실내 사이클 30분, 땅끄부부 칼소폭 10분, 스쿼트20회 3세트, 스트레칭 10분", "유산소", "전신", 60, 13, 0),
("강해진", "주말 루틴", "실내 사이클 30분, 스쿼트20회 3세트, 런지 20회 3세트, 스트레칭 10분", "유산소", "하체", 60, 13, 1);
...
VALUES ("강해진", "헬스장 초보자 루틴 추천 좀 해주세요!!!!🚨🚨🚨", "헬스 완전 초보라서 루틴 추천 부탁드립니다! 기구사용 아무것도 몰라서 걱정이에요..", 13);
...
"여자배구단 취미로 하는 팀이 있는데, 대결 상대 하실 다른 취미 여배팀 있나요?", 15);
...
VALUES ("독고수", "너무 무리하지 마시고 아는 기구부터 한번 도전해보세요^^ 사용해본 기구들 글로 남겨주셔도 좋습니다.", 1, 11),
("요가영", "요가도 함께 하는건 어떠신지요?ㅎㅎ 요가로 전신을 순환시켜 보세요", 1, 12);
...
INSERT INTO poi-- nt (record, amount, user_id)
-- VALUES ("루틴 완료", "100", 13),
-- ("루틴 완료", "100", 14),
-- ("루틴 완료", "100", 15),
-- ("루틴 완료", "100", 16);
