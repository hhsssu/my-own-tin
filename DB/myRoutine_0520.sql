...
CREATE TABLE IF NOT EXISTS `myroutine`.`users` (
  ...
  `character1` VARCHAR(20) NULL COMMENT '성격1',
  `character2` VARCHAR(20) NULL COMMENT '성격2',
  `character3` VARCHAR(20) NULL COMMENT '성격3',
...
CREATE TABLE IF NOT EXISTS `myroutine`.`routines` (
  ...
  `routine_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '루틴날짜',
